...
// Attributes
public:
	void	SetView(CSignalStudioView *View);
	...
	int		FindRuler(const CCodeRulerControl *Ruler) const;
...
// Types
	typedef CArrayEx<CChannelRulerController*, CChannelRulerController*&> CRulerPtrArray;

// Data members
	CRulerPtrArray	m_Ruler;	// array of pointers to ruler windows
	CSignalStudioView	*m_View;	// pointer to wave view
...
inline void CChannelBar::SetView(CSignalStudioView *View)
{
	m_View = View;
}
