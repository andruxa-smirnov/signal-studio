...
#ifndef CMP4DecoderWrapper_INCLUDED
#define CMP4DecoderWrapper_INCLUDED

#include "libmp4head.h"
#include "MP4DecoderFunctions.h"
#include "DllWrap.h"
#include "ProgressDlg.h"

class CWave;

class CMP4DecoderWrapper : public WObject {
public:
// Construction
	CMP4DecoderWrapper();
	~CMP4DecoderWrapper();
...
inline void CMP4DecoderWrapper::CFileEx::SetCloseOnDelete(bool Enable)
{
