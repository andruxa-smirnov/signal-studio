...
#if !defined(AFX_CodeRecord_H__C4563F72_D33B_404D_8331_2A1DE732DBAB__INCLUDED_)
#define AFX_CodeRecord_H__C4563F72_D33B_404D_8331_2A1DE732DBAB__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CodeRecord.h : header file
//
...
class CCodeRecord : public CCodePersist
{
// Construction
public:
	CCodeRecord(CString OutPath, CWnd* pParent = NULL);   // standard constructor
	~CCodeRecord();
	static	CCodeRecord	*Record();
...
// Types
	class CWaveDSCap : public CDSCap {
	public:
...
// Data members
	...
	CDSCap	m_RecordCapture;	// capture instance for recording
	CWaveDSCap	m_MeterCapture;	// capture instance for meter view
	...
	CNumFormatter	m_NumFormatter;	// numeric formatter
...
inline bool	CCodeRecord::IsRecording() const
{
	return(m_RecordCapture.IsOpen());
}

inline bool	CCodeRecord::IsPaused() const
{
	return(!m_RecordCapture.IsCapturing());
}

inline UINT CCodeRecord::GetTimerFrequency()
{
...
#endif // !defined(AFX_CodeRecord_H__C4563F72_D33B_404D_8331_2A1DE732DBAB__INCLUDED_)
