...
#if !defined(AFX_CodeSpectrum_H__1E61CD05_C1F0_49C5_89EA_653327F7C1C7__INCLUDED_)
#define AFX_CodeSpectrum_H__1E61CD05_C1F0_49C5_89EA_653327F7C1C7__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// CodeSpectrum.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CCodeSpectrum window

#include "FnAnalyze.h"
#include "PlotCtrl.h"
#include "CodeOptionsInfo.h"

class CCodeSpectrum : public CSizingControllerBar
{
	DECLARE_DYNAMIC(CCodeSpectrum);
// Construction
public:
	CCodeSpectrum();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCodeSpectrum)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CCodeSpectrum();

	// Generated message map functions
protected:
	//{{AFX_MSG(CCodeSpectrum)
...
// Member data
	...
	CFnAnalyze	m_Anal;		// spectrum analyzer
...
inline void CCodeSpectrum::GetParms(RTSA_PARMS& Parms) const
{
	Parms = m_Parms;
}

inline bool CCodeSpectrum::IsValidArrayPtr(const CByteArray& Arr, const BYTE *Ptr)
{
...
#endif // !defined(AFX_CodeSpectrum_H__1E61CD05_C1F0_49C5_89EA_653327F7C1C7__INCLUDED_)
