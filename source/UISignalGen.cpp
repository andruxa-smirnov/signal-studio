...
// UISignalGen.cpp : implementation file
...
const int CUISignalGen::m_OscName[OSCILLATORS] = {
	IDS_WGEN_OSC_CARRIER,
	IDS_WGEN_OSC_MODULATOR,
};

const WAVEGEN_MAIN_PARMS CUISignalGen::m_Defaults = {
	2,			// m_Channels
	44100,		// m_SampleRate
	16,			// m_SampleBits
	1.0,		// m_Duration
...
CUISignalGen::CUISignalGen(CWnd* pParent /*=NULL*/)
	: CDialog(IDD, pParent)
{
	//{{AFX_DATA_INIT(CUISignalGen)
	//}}AFX_DATA_INIT
	WAVEGEN_MAIN_PARMS::operator=(m_Defaults);
	m_OscDlg[MODULATOR].m_Frequency = 1;	// differ from carrier for clarity
}

void CUISignalGen::GetParms(WAVEGEN_PARMS& Parms) const
{
...
void CUISignalGen::SetParms(const WAVEGEN_PARMS& Parms)
{
...
bool CUISignalGen::MakeWave(const WAVEGEN_PARMS& Parms, CWave& Wave, CProgressDlg *ProgressDlg)
{
...
void CUISignalGen::ShowOscDlg(int TabIdx)
{
	for (int iOsc = 0; iOsc < OSCILLATORS; iOsc++) {	// for each oscillator
...
void CUISignalGen::ResizeOscDlgs()
{
	CRect	rOscTab;
...
void CUISignalGen::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CUISignalGen)
	//}}AFX_DATA_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CUISignalGen message map

BEGIN_MESSAGE_MAP(CUISignalGen, CDialog)
	//{{AFX_MSG_MAP(CUISignalGen)
	ON_WM_CREATE()
...
/////////////////////////////////////////////////////////////////////////////
// CUISignalGen message handlers

BOOL CUISignalGen::OnInitDialog() 
{
...
int CUISignalGen::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CUISignalGen::OnSelchangeOscTab(NMHDR* pNMHDR, LRESULT* pResult) 
{
	int	sel = m_OscTab.GetCurSel();
	if (sel >= 0) {
		ShowOscDlg(sel);
...
void CUISignalGen::OnSweep() 
{
	...
	CUISignalGenOsc&	CarDlg = m_OscDlg[CARRIER];
	...
	CUISignalGenOsc&	ModDlg = m_OscDlg[MODULATOR];
