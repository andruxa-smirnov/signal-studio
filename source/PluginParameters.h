...
#ifndef CPluginParameters_INCLUDED
#define	CPluginParameters_INCLUDED

#include "ClickSliderController.h"

struct _LADSPA_Descriptor;

class CPluginParameters : public WObject {
public:
// Construction
	CPluginParameters();
...
// Data members
	...
	CClickSliderController	m_Slider;	// value slider control
...
inline CFloatRange CPluginParameters::GetBounds() const
{
	return(m_Bounds);
}

inline CString CPluginParameters::GetName() const
{
	return(m_Name);
}
