...
#if !defined(AFX_EditSlider_H__810797E4_C040_4E3D_98F7_C75B7C55507D__INCLUDED_)
#define AFX_EditSlider_H__810797E4_C040_4E3D_98F7_C75B7C55507D__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// EditSlider.h : header file
//
...
class CEditSlider : public CClickSliderController
{
	DECLARE_DYNAMIC(CEditSlider);
// Construction
public:
	CEditSlider();
...
inline double CEditSlider::GetVal() const
{
	return(m_Val);
}

inline void CEditSlider::SetScale(double Scale)
{
	m_Scale = Scale;
}

inline void CEditSlider::SetLogBase(double Base)
{
	m_LogBase = Base;
}

inline CNumEdit *CEditSlider::GetEditCtrl() const
{
	return(m_Edit);
}
...
#endif // !defined(AFX_EditSlider_H__810797E4_C040_4E3D_98F7_C75B7C55507D__INCLUDED_)
