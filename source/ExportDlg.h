...
// Member data
	...
	CCodeSndFile	m_SndFile;		// sndfile library interface	
	CSignalFileFormatArray	m_MajorFormat;	// array of major formats
	CSignalFileFormatArray	m_Subtype;	// array of subtypes
