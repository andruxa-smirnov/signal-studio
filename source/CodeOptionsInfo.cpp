...
const OPTIONS_INFO CCodeOptionsInfo::m_DefaultCodeOptionsInfo = {
	200,	// m_ZoomStepHorz
	200,	// m_ZoomStepVert
	...
	{		// m_RTSA
		CFnAnalyze::WF_HANN,		// WindowFunction
		4096,						// WindowSize
		0,							// Averaging
		CCodeSpectrum::PS_LINE,		// PlotStyle
		CCodeSpectrum::FAT_LOG,		// FreqAxisType
		CCodeSpectrum::CM_SEPARATE,	// ChannelMode
		FALSE,						// ShowPeaks
		500,						// PeakHoldTime
		20,							// PeakDecay
...
const CCodeOptionsInfo CCodeOptionsInfo::m_Defaults(m_DefaultCodeOptionsInfo);

IMPLEMENT_SERIAL(CCodeOptionsInfo, CObject, 1);

CCodeOptionsInfo::CCodeOptionsInfo()
{
...
void CCodeOptionsInfo::Copy(const CCodeOptionsInfo& Info)
{
...
CString CCodeOptionsInfo::GetTempFolderPath() const
{
	CString	path;
